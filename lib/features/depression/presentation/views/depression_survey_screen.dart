...
import 'package:rafiq_app/features/depression/presentation/cubit/postpartum_survey_state.dart';
import '../widgets/depression_app_bar.dart';
import '../widgets/depression_progress_bar.dart';
import '../widgets/depression_answer_option.dart';
import '../../../../core/common/widgets/app_primary_button.dart';
...
class _DepressionSurveyScreenState extends State<DepressionSurveyScreen> {
  ...
  final List<String> questions = [
    ...
    'Moving or speaking slowly',
    'Thoughts you would be better off dead',
    'Feeling anxious or overwhelmed without clear reason', // 👈 NEW
  ];
  ...
  void next() {
    if (currentIndex < questions.length - 1) {
      ...
      context.read<PostpartumSurveyCubit>().submit();
    }
  }
  ...
  @override
  Widget build(BuildContext context) {
    return BlocListener<PostpartumSurveyCubit, PostpartumSurveyState>(
      listener: (context, state) {
        if (state is SurveySuccess) {
          context.go(
            AppRoutes.depressionResultScreen,
            extra: {
              ...
              children: [
                ...
                ...List.generate(
                  ...
                  (index) => DepressionAnswerOption(
                    ...
                    onTap: () {
                      ...
                      context
                          .read<PostpartumSurveyCubit>()
                          .updateAnswer(currentIndex, index);
                    },
                  ),
                ),
                ...
                Row(
                  children: [
                    ...
                    16.w.horizontalSpace,
                    Expanded(
                      child: BlocBuilder<PostpartumSurveyCubit,
                          PostpartumSurveyState>(
                        builder: (context, state) {
                          final isLoading = state is SurveyLoading;
