...
class GrowthSuccessScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    ///  نستقبل childId من الـ extra عشان نرجع للـ tracker الصح
    /// لو مفيش extra → نروح لـ selectChild
    final childId = GoRouterState.of(context).extra as String?;
              ...
              GrowthAppBar(
                ...
                onBack: () {
                  if (childId != null) {
                    ...
                    context.go(AppRoutes.selectChildScreen);
                  }
                },
              ),
