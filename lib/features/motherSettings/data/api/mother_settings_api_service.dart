...
abstract class MotherSettingsApiService {
  ...
  Future<BasicResponse> editProfile(@Body() Map<String, dynamic> body);

  /// DELETE ACCOUNT
  @DELETE('motherprofile/delete-account')
  Future<BasicResponse> deleteAccount(@Body() Map<String, dynamic> body);

  /// MAKE ADMIN
  @POST('Auth/make-admin')
  Future<BasicResponse> makeAdmin(@Body() Map<String, dynamic> body);
}
